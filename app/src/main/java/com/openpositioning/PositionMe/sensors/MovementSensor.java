 ...
 *
 * <p>The class is initialised with the application context to be used for permissions and hardware
...
public class MovementSensor {
     ...
     *
     * <p>It calls the superclass constructor with context, and then initialises local properties.
     *
    ...
    public MovementSensor(Context context, int sensorType) {
        ...
        if (sensor != null) {
            ...
            this.sensorInfo = new SensorInfo("Not available", "-", -1.0f, 0.0f, 0, 0, 0.0f, 0.0f);
        }
    }
}
