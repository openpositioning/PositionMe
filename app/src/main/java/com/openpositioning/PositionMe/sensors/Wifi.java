 ...
 *
 * <p>It contains the ssid (the identifier of the wifi), bssid (the mac address of the wifi), level
...
public class Wifi {
     ...
     *
     * <p>Concatenates mac address and rssi to display in the {@link MeasurementsFragment} fragment
     */
    @Override
