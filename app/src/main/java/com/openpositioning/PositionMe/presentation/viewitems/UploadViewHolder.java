...
public class UploadViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    /**
     * {@inheritDoc} Assign TextView fields corresponding to Trajectory file metadata.
     *
     * @param listener DownloadClickListener to enable acting on clicks on items.
     * @see UploadFragment locating the data and implementing the listener.
     */
    ...
    /** {@inheritDoc} Calls the onPositionClick function on the listenerReference object. */
    @Override
