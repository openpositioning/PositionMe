...
// import com.openpositioning.PositionMe.fragments.StartLocationFragmentDirections;
...
public class StartLocationFragment extends Fragment {
    ...
    //Zoom of google maps
    private com.openpositioning.PositionMe.utils.NucleusBuildingManager NucleusBuildingManager;
...
//        }
    ...
    private void switchFloorNU(int floorIndex) {
        ...
        if (NucleusBuildingManager != null) {
            // Call the switchFloor method of the IndoorMapFragment to switch to the specified floor
