...
/**
 * The RecordingActivity manages the recording flow of the application, guiding the user through a
 * sequence of screens for location selection, recording, and correction before finalizing the
 * process.
 *
 * <p>This activity follows a structured workflow:
 *
 * <ol>
 *   <li>StartLocationFragment - Allows users to select their starting location.
 *   <li>RecordingFragment - Handles the recording process and contains a TrajectoryMapFragment.
 *   <li>CorrectionFragment - Enables users to review and correct recorded data before completion.
 * </ol>
 *
 * <p>The activity ensures that the screen remains on during the recording process to prevent
 ...
 * @see CorrectionFragment Allows users to review and make corrections before finalizing the
 *     process.
 * @see com.openpositioning.PositionMe.R.layout#activity_recording The associated layout for this
 *     activity.
 * @author ShuGu
 */
