...
public class UploadListAdapter extends RecyclerView.Adapter<UploadViewHolder> {
    ...
    public UploadListAdapter(
            Context context, List<File> uploadItems, DownloadClickListener listener) {
    ...
    public UploadViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UploadViewHolder(
                LayoutInflater.from(context).inflate(R.layout.item_upload_card_view, parent, false),
                listener);
    }

    /**
     * {@inheritDoc} Formats and assigns the data fields from the local Trajectory Files object to
     * the TextView fields.
     *
    ...
    /** {@inheritDoc} Number of local files. */
    @Override
