...
// Parameter pointA: Starting point
// Parameter pointB: Ending point
// Returns: Angle between the points
    ...
    // (as per WGS84 datum)
// Parameter initialLocation: Current Location of user
// Parameter pdrMoved: Amount of movement along X and Y
// Returns: new Coordinates based on the movement
    ...
    // (as per WGS84 datum)
// Parameter degreeVal: Value in degrees to convert to meters
// Returns: double corresponding to the value in meters.
    ...
    // (as per WGS84 datum)
// Parameter degreeVal: Value in degrees to convert to meters
// Parameter latitude: the latitude of the current position
// Returns: double corresponding to the value in meters.
...
// Parameter pointA: initial point
// Parameter pointB: final point
...
// Parameter context: Context of activity being used
// Parameter vectorResourceID: Resource id whose vector get converted to a Bitmap
// Returns: Bitmap of the resource vector
