...
public class UtilFunctions {
    ...
    /**
     * Calculate new coordinates based on net distance moved in PDR (as per WGS84 datum)
     *
    ...
    /**
     * Converts a degree value of Latitude into meters (as per WGS84 datum)
     *
    ...
    /**
     * Converts a degree value of Longitude into meters (as per WGS84 datum)
     *
     * @param degreeVal Value in degrees to convert to meters
    ...
    /**
     * Calculates the distance between two LatLng points A and B (in meters) (Note: approximation:
     * for short distances)
     *
    ...
    public static double distanceBetweenPoints(LatLng pointA, LatLng pointB) {
        return Math.sqrt(
                Math.pow(degreesToMetersLat(pointA.latitude - pointB.latitude), 2)
                        + Math.pow(
                                degreesToMetersLng(
                                        pointA.longitude - pointB.longitude, pointA.latitude),
                                2));
    }
